    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Link href="/routes/new" className="inline-flex items-center gap-2 rounded-lg bg-[#0000FF] px-4 py-2 text-sm font-semibold text-white hover:bg-[#0000CC] transition-colors">
