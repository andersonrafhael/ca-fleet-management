    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Link href="/operation-days/new" className="inline-flex items-center gap-2 rounded-xl bg-[#0000FF] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#0000DD] hover:shadow-md hover:shadow-blue-500/20 transition-all duration-200">
